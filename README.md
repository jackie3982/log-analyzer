...
- Identifies most frequent and suspicious IP addresses
- Detects repeated login failures (potential brute force attacks)
- Processes and summarizes log data for easy analysis
